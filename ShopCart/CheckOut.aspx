<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CheckOut.aspx.cs" Inherits="ShopCart_CheckOut" %>
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> Account <span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            ...
                            <li class="active"><a href="ShopCart.aspx"> Cart </a></li>
                        </ul>
            </ul>
        </div><!-- /.navbar-collapse -->
    </div><!-- /.container-fluid -->
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <p>Thank you for doing business with us. We hope you enjoyed you time on the website.</p>
    <p><asp:Button ID="btnreturn4" runat="server" Text="Return to Home Page" ForeColor="Black" OnClick="btnreturn_click" /></p>
</div>
